...
//		{separator:'---------------' },
		...
		{separator:'---------------' },
                {name:'Php', openWith:'[code=php]', closeWith:'[/code]' ,className:'php'},
                {name:'C#', openWith:'[code=csharp]', closeWith:'[/code]' ,className:'csharp'},
                {name:'Xml', openWith:'[code=xml]', closeWith:'[/code]' ,className:'xml'},
                {name:'Javascript', openWith:'[code=js]', closeWith:'[/code]' ,className:'js'},
                {name:'Css', openWith:'[code=css]', closeWith:'[/code]' ,className:'css'},
                {name:'Sql', openWith:'[code=sql]', closeWith:'[/code]' ,className:'sql'},
